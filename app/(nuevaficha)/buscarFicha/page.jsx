          ...
          <div className="card container">
            <div className="card-body">
              <div className="text-center">
                <h3 className="card-title mb-1">Buscar Familia </h3>
              </div>
                ...
                <div className="row">
                  <div className="col-sm-12 col-md-6 col-xl-6">
                    ...
                    >
                      ...
                      <option value={1}>Número de Ficha Familiar</option>
          ...
          <div>
            <div className="card mt-2 container card-body border-light ">
              {listaFamilia.length > 0 ? (
                <button
                  type="button"
                  className="btn shadow p-6 mb-3 rounded"
                  style={{ backgroundColor: "#2d2d93", color: "white" }}
                  onClick={() =>
                    router.push(
